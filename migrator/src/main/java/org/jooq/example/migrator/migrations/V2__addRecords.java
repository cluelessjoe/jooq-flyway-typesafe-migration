...
public class V2__addRecords extends JooqMigration {
    ...
    public void migrate(Connection connection, DSLContext create) throws Exception {
        create.insertInto(v1_AUTHOR).values(Sequences.S_AUTHOR_ID.nextval(), "George", "Orwell", "1903-06-25", 1903, null).execute();
        create.insertInto(v1_AUTHOR).values(Sequences.S_AUTHOR_ID.nextval(), "Paulo", "Coelho", "1947-08-24", 1947, null).execute();
